...
$HPHP_HOME/hphp/hhvm/hhvm --mode server -c "$H_CONFIG" -v "DynamicExtensionPath=$H_EXT_PATH" -vServer.Type=fastcgi -vServer.FileSocket="/tmp/treffynnon_bench.socket" -vEval.Jit=0 > /dev/null 2>&1 &
